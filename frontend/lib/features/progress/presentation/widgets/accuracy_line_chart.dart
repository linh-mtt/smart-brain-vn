...
/// Line chart displaying accuracy history over time.
///
/// Shows a curved gradient-filled line with touch tooltips.
class AccuracyLineChart extends StatelessWidget {
  const AccuracyLineChart({super.key, required this.dataPoints});

  /// Accuracy data points sorted by date.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Accuracy Trend', style: AppTextStyles.heading4),
  ...
  LineChartData _buildChartData() {
    ...
    return LineChartData(
      ...
      minY: (minY - yPadding).clamp(0, 100),
      maxY: (maxY + yPadding).clamp(0, 100),
